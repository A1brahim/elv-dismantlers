...
TEXT = {
    "English": {
        ...
        "page_subtitle": "Structural financial comparison of selected Swedish End-of-Life Vehicle Dismantlers based on publicly available financial statements. Only <a href='https://sbrservice.se/skrota-din-bil-bilskrot/bildemonterare' target='_blank'>SBR (Sveriges Bilåtervinnares Riksförbund)-affiliated dismantling businesses</a> have been included in the analysis.",
        "filters": "Filters",
